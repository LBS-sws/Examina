...
class ConcludePaperList extends CListPageModel
{
    public $menu_id;
    public $menu_name;
    public $menu_code;
	...
	public function retrieveDataByPage($pageNum=1)
	{
		...
		$sql1 = "select a.*,f.code as employee_code,f.name as employee_name,b.name as markedly_name,b.join_must,b.exa_num from exa_take a 
        ...
        $session['concludePaper_'.$this->menu_code] = $this->getCriteria();
		return true;
	}
